...
class Counters:
    PATH = '/tmp/surface-ec-counters.json'

    @staticmethod
    def load():
        if os.path.isfile(Counters.PATH):
...
class Bix(Command):
    ...
    def _handle_payload(self, pld):
        ...
        return {
            ...
            'Bat Present': hex(to_int(pld[13:17])),
            ...
            'Technology': pld[93:98].decode().rstrip('\0'),
            'Manufacturer': pld[98:119].decode().rstrip('\0'),
        }
